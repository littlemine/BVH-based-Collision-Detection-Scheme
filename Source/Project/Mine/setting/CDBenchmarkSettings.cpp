...
namespace mn {
	...
	std::vector<Benchmark>	CDBenchmarkSettings::_benchmarks({
		...
		*/
		...
		Benchmark{ 1, 501, "funnel.plys\\%03d.ply", "funnel-18k","%s\\%s.txt",{ CDSchemeType::REFIT_ONLY_FRONT, "refit_only" } },
		...
		Benchmark{ 1, 501, "funnel.plys\\%03d.ply", "funnel-18k","%s\\%s.txt",{ CDSchemeType::STATIC_MANDATORY, "static_mandatory" } },
